...
def desenhar_personagem(frame_idx):
    ...
    # Olhos (Correção aplicada aqui)
    surf.set_at((cx + 3, cy - 1), OLHOS)
    surf.set_at((cx + 3, cy + 1), OLHOS)
...
print("✅ Novo spritesheet 'personagem.png' gerado com sucesso!")